...
#ifndef MPU6050_PROCESS_H_
#define MPU6050_PROCESS_H_
...
//so I broke it up into 16 byte transmission payloads which are sent in the dmpInit() function below.
//
...
static byte dmp_updates[29][9] =
{
  ...
  ,
  {
    0x03, 0x7F, 0x06, 0x0C, 0xC9, 0x2C, 0x97, 0x97, 0x97 } //FCFG_2 inv_set_sensors
  ,
  {
...
class MPU6050Pro
{
	...
	public:
		...
		static byte processed_packet[8];
		static byte received_packet[50];
		static byte temp;
		static byte fifoCountL;
		static byte fifoCountL2;
		static byte packetCount;
		static byte longPacket;
		static byte firstPacket;
		static float quat[4];
		...
		void sendPacket();
		void sendHeader();
		void bankSel(byte bank);
		void printFloatArr(float * arr, int length);
		void printFloat(float f);
		void sendQuat();
};

unsigned long MPU6050Pro::lastRead = 0;
byte MPU6050Pro::processed_packet[8];
byte MPU6050Pro::received_packet[50];
byte MPU6050Pro::temp = 0;
byte MPU6050Pro::fifoCountL = 0;
byte MPU6050Pro::fifoCountL2 = 0;
byte MPU6050Pro::packetCount = 0x00;
byte MPU6050Pro::longPacket = false;
byte MPU6050Pro::firstPacket = true;
float MPU6050Pro::quat[4];
...
/*===============================================================================================
  ...
  Return value :  None.
================================================================================================*/
void MPU6050Pro::memInit()
{
	dmpInit();

	for(byte i = 0; i < 22; i++)
	{
		bankSel(dmp_updates[i][0]);
		Wire.beginTransmission(MPU_ADDR);
		Wire.write(MEM_START_ADDR);
...
/*===============================================================================================
  ...
  Return value :  None.
================================================================================================*/
void MPU6050Pro::regWrite(byte addy, byte regUpdate)
{
	Wire.beginTransmission(MPU_ADDR);
	Wire.write(addy);
...
/*===============================================================================================
  ...
  Return value :  None.
================================================================================================*/
byte MPU6050Pro::regRead(byte addy)
{
	Wire.beginTransmission(MPU_ADDR);
	Wire.write(addy);
	Wire.endTransmission();
...
/*===============================================================================================
  ...
  Return value :  None.
================================================================================================*/
void MPU6050Pro::bankSel(byte bank)
{
	Wire.beginTransmission(MPU_ADDR);
	Wire.write(0x6D);
	Wire.write(bank);
...
/*===============================================================================================
  ...
  Return value :  None.
================================================================================================*/
void MPU6050Pro::printFloatArr(float * arr, int length)
{
...
/*===============================================================================================
  ...
  Return value :  None.
================================================================================================*/
void MPU6050Pro::printFloat(float f)
{
	byte * b = (byte *) &f;
